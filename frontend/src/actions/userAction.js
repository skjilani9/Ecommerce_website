import {LOGIN_FAIL,LOGIN_SUCCESS,CLEAR_ERRORS,  UPDATE_PROFILE_FAIL,
    ...
    UPDATE_PROFILE_SUCCESS, LOGIN_REQUEST, REGISTER_USER_REQUEST, REGISTER_USER_SUCCESS, REGISTER_USER_FAIL, LOAD_USER_REQUEST, LOAD_USER_FAIL,  UPDATE_PASSWORD_REQUEST,
    ALL_USERS_REQUEST,
    ALL_USERS_SUCCESS,
    ALL_USERS_FAIL,
    DELETE_USER_REQUEST,
    ...
    UPDATE_PASSWORD_SUCCESS, LOGOUT_FAIL,LOGOUT_SUCCESS,LOAD_USER_SUCCESS, FORGOT_PASSWORD_REQUEST, FORGOT_PASSWORD_SUCCESS, FORGOT_PASSWORD_FAIL, RESET_PASSWORD_REQUEST, RESET_PASSWORD_SUCCESS, RESET_PASSWORD_FAIL} from '../constants/userConstant'
...
///Admin user handle starts from here
// get All Users
